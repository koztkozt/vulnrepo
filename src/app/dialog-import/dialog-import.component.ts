      ...
      myObject.Vulnerabilities.forEach((myObject2, index) => {
        ...
        if (Object.values(intvulns).indexOf(myObject2.VulnerabilityID) > -1) {
          ...
          const def = {
            ...
            ref: reff,
            affected_assets: myObject.Target || '',
            recommendations: myObject2.FixedVersion ? 'Update to version: ' + myObject2.FixedVersion : '',
            cvss: cvss,
            cvss_vector: '',
            cve: '',
            tags: [{ name: "trivy" }],
    ...
    issues.forEach((myObject:any, index) => {
      ...
      if (myObject) {
        const def = {
          ...
          ref: myObject[26],
          affected_assets: myObject[3] || '',
          recommendations: myObject[25] || '',
          cvss: '',
          cvss_vector: '',
          cve: '',
          tags: [{ name: "wiz" }],
